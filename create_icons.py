...
ICONS = {
    ...
    "speed": '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 12A10 10 0 1 0 2 12"/><path d="M12 2a10 10 0 0 1 10 10"/><path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12"/><circle cx="12" cy="12" r="2"/><path d="M13.4 10.6 19 5"/></svg>''',
    
    "timer": '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="14" r="8"/><path d="M12 6V2"/><path d="M16.24 7.76 19.07 4.93"/></svg>''',
